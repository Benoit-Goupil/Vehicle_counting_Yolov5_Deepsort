...
def detect(opt):
    ...
    dictmask1 = {'parametres' : {'coordonnees' : [1200,150,600,250], 'cpt_b_car' : 0, 'cpt_b_truck' : 0, 'cpt_h_car' : 0, 'cpt_h_truck' : 0}, 'classes' : {}} 
    dictmask2 = {'parametres' : {'coordonnees' : [1920,1300,600,250], 'cpt_b_car' : 0, 'cpt_b_truck' : 0, 'cpt_h_car' : 0, 'cpt_h_truck' : 0}, 'classes' : {}} 
    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            cv2.putText(im0,str(dictmask1['parametres']['cpt_b_car']), (180, 250), font, fontScale, (255, 0, 0),thickness,lineType)
            cv2.putText(im0,str(dictmask1['parametres']['cpt_b_truck']), (380, 250), font, fontScale, (0, 255, 0),thickness,lineType)
            cv2.putText(im0,str(dictmask2['parametres']['cpt_h_car']), (1150, 400), font, fontScale, (255, 0, 0),thickness,lineType)
            cv2.putText(im0,str(dictmask2['parametres']['cpt_h_truck']), (1350, 400), font, fontScale, (0, 255, 0),thickness,lineType)
                ...
                if mask['classes'][i_car][2] > threshold_disp:                 #suppression if yes
                    if mask['classes'][i_car][0] + mask['classes'][i_car][1] > threshold_seen: #counting activated
                        if mask['classes'][i_car][0] >= mask['classes'][i_car][1]:
                            if mask['classes'][i_car][3] == 'b':
                                mask['parametres']['cpt_b_car'] += 1
                            else:
                                mask['parametres']['cpt_h_car'] += 1
                        else:
                            if mask['classes'][i_car][3] == 'b':
                                mask['parametres']['cpt_b_truck'] += 1
                            else:
                                mask['parametres']['cpt_h_truck'] += 1
                    ...
                    if car[2] in mask['classes'].keys():
                        ...
                        if mask['classes'][car[2]][3] is None:
                            ...
                            if valid and speed > 0:
                                mask['classes'][car[2]][3] = 'h'
                            elif valid:
                                mask['classes'][car[2]][3] = 'b'
                    else:
                        if car[3] == 2: 
